// Output Order:
// a= 100 (Synchronous)
// Last line of the file. (Synchronous) 
// Process.nextTick (Next Tick phase) - runs after each phase
// promise (Microtask phase)  - runs after each phase
// Timer expired (Timers phase)
// setImmediate (Check phase)
// File Reading CB (Poll phase)
// ****************************************

const fs = require("fs");
const a = 100;

// in the Check phase (runs after Poll phase)
